...
def test_get_provider_registry_resolves() -> None:
    from kavach.api.dependencies import get_provider_registry
...
def test_get_provider_registry_registers_only_mock_without_trulens_configuration(
    ...
    monkeypatch.delenv("KAVACH_TRULENS_MODEL", raising=False)
...
def test_get_experiment_repository_resolves() -> None:
    from kavach.api.dependencies import get_experiment_repository
...
def test_get_ontology_sync_event_publisher_resolves() -> None:
    from kavach.api.dependencies import get_ontology_sync_event_publisher
...
def test_get_audit_read_service_resolves() -> None:
    from kavach.api.dependencies import get_audit_read_service
...
def test_evaluation_api_service_resolves() -> None:
    from kavach.api.dependencies import get_evaluation_api_service
...
def test_governance_decision_application_service_resolves() -> None:
    from kavach.api.dependencies import get_governance_decision_application_service
...
def test_governance_report_service_resolves() -> None:
    from kavach.api.dependencies import get_governance_report_service
