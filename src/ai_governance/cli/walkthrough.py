...
from ai_governance.mcp.clients.rest_client import RestClientError

if TYPE_CHECKING:
    from ai_governance.cli.walkthrough_renderers import WalkthroughRenderer
...
def run_governed_replay(
    ...
    *,
    ...
    """Run the golden path without reaching beneath AI Governance Control Plane's public REST API."""
...
def cleanup_walkthrough_manifests(
    *, root: Path | None = None, older_than_days: int = 7, apply: bool = False
    ...
    This never calls AI Governance Control Plane APIs and never removes governed assets. Requiring
    ...
    directory = (root or Path.cwd()) / ".ai-governance" / "walkthroughs"
