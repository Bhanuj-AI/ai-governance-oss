...
- `src/ai_governance/api/app.py:create_app` composes routers and authorization
  dependencies.
- `src/ai_governance/api/dependencies/tenancy.py` resolves request scope; routers use
...
- Repository factories are reached through dependency providers such as
  `src/ai_governance/api/dependencies/repositories.py`, not from routes.
