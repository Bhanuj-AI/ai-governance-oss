...
from ai_governance.ontology.repositories import OntologyGraphRepository
...
from ai_governance.services.job_submission_service import stable_input_hash
...
def _audit_spec(
    ...
    *,
    ...
    client_name: str | None = "AI Governance Control Plane Studio",
