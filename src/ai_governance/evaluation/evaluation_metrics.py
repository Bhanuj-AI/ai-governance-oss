...
def normalize_metric_name(
    ...
    """
    Normalize a human or provider-facing metric name into AI Governance Control Plane's key format.
...
class EvaluationMetricSpec:
    ...
    Metric specs let callers ask for canonical AI Governance Control Plane metrics while optionally
