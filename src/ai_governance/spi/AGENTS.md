...
This directory owns public extension and provider contracts consumed by AI Governance Control Plane
core and separately released plugins.

## Architectural Facts

`AIGovernancePlugin` implementations may consume `ai_governance.spi`, `ai_governance.plugins`,
`ai_governance.hooks`, and `ai_governance.events`. Provider selection and explicit replacement
