...
- Concrete repository implementations live under `src/kavach/repositories`;
...
- PostgreSQL migration tooling is exposed through
  `src/kavach/databases/postgres/cli.py`.
...
See `src/kavach/repositories/AGENTS.md` for the public persistence contracts.
