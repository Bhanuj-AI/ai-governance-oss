    ...
    def create(self) -> PromptRepository:
        ...
        match backend:
            ...
            case "sqlite":
                ...
                if not path:
                    raise ValueError(
                        "KAVACH_PROMPT_SQLITE_PATH is required when "
            ...
            case "postgres":
                ...
                if not dsn:
                    raise ValueError(
                        "KAVACH_PROMPT_POSTGRES_DSN is required when "
                        "KAVACH_PROMPT_REPOSITORY=postgres"
                    )
                from kavach.databases.postgres.database import PostgresDatabase
                from kavach.repositories.postgres import PostgresPromptRepository
