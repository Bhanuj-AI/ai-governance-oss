...
_DEFINITIONS = (
    _definition(
        ...
        C.GENERAL,
        "Instance Name",
        "Human-readable Kavach instance name.",
        T.STRING,
        "Kavach",
        env="KAVACH_INSTANCE_NAME",
    ...
    _definition(
        ...
        "inmemory",
        mutable=False,
        env="KAVACH_SETTINGS_REPOSITORY",
        restart=True,
        enum=("inmemory", "sqlite", "postgres"),
    ),
    _definition(
    ...
    _definition(
        ...
        T.INTEGER,
        4,
        env="KAVACH_JOB_WORKER_CONCURRENCY",
    ...
    _definition(
        ...
        T.INTEGER,
        4,
        env="KAVACH_REPLAY_MAX_CONCURRENT_JOBS",
        validator=_range(1, 128),
        runtime_applied=True,
    ),
    _definition(
        ...
        T.INTEGER,
        2,
        env="KAVACH_REPLAY_MAX_CONCURRENT_JOBS_PER_PROJECT",
        validator=_range(1, 128),
        runtime_applied=True,
    ),
    _definition(
        ...
        T.INTEGER,
        3,
        env="KAVACH_REPLAY_MAX_ATTEMPTS",
        validator=_range(1, 10),
        runtime_applied=True,
    ),
    _definition(
        ...
        T.ENUM,
        "LATEST_COMPATIBLE",
        env="KAVACH_REPLAY_DEFAULT_BASELINE_STRATEGY",
    ...
    _definition(
        ...
        T.INTEGER,
        3,
        env="KAVACH_REPLAY_EVALUATION_MAX_ATTEMPTS",
        validator=_range(1, 10),
        runtime_applied=True,
    ),
    _definition(
        ...
        env="KAVACH_REPLAY_DRIFT_THRESHOLD_POLICY",
        runtime_applied=True,
    ),
    _definition(
        ...
        T.DURATION,
        "90d",
        env="KAVACH_REPLAY_RESULT_RETENTION",
        runtime_applied=True,
    ),
    _definition(
        ...
        T.INTEGER,
        3,
        env="KAVACH_INTELLIGENCE_REPLAY_HISTORY_LIMIT",
    ...
    _definition(
        ...
        T.STRING,
        "openai",
        env="KAVACH_INTELLIGENCE_SYNTHESIZER_PROVIDER",
        validator=_non_empty,
        runtime_applied=True,
    ),
    _definition(
        ...
        T.STRING,
        "gpt-4.1-mini",
        env="KAVACH_INTELLIGENCE_SYNTHESIZER_MODEL",
        validator=_non_empty,
        runtime_applied=True,
    ),
    _definition(
        ...
        env="KAVACH_INTELLIGENCE_SYNTHESIZER_PRICING",
    ...
    _definition(
        ...
        T.BOOLEAN,
        True,
        env="KAVACH_ENTERPRISE_RECOMMENDATIONS_ENABLED",
        runtime_applied=True,
    ),
    _definition(
    ...
    _definition(
        ...
        T.ENUM,
        "active",
        env="KAVACH_DEFAULT_POLICY_VERSION_BEHAVIOR",
    ...
    _definition(
        ...
        T.STRING,
        "mock",
        env="KAVACH_DEFAULT_EVALUATION_PROVIDER",
        validator=_non_empty,
        runtime_applied=True,
    ),
    _definition(
        ...
        T.FLOAT,
        0.8,
        env="KAVACH_EVALUATION_PASS_THRESHOLD",
    ...
    _definition(
        ...
        T.JSON,
        {},
        env="KAVACH_EVALUATION_THRESHOLDS",
        runtime_applied=True,
    ),
    _definition(
        ...
        T.DURATION,
        "180d",
        env="KAVACH_EVALUATION_RETENTION",
        runtime_applied=True,
    ),
    _definition(
        ...
        T.DURATION,
        "30s",
        env="KAVACH_ONTOLOGY_PROJECTION_INTERVAL",
        runtime_applied=True,
    ),
    _definition(
        ...
        T.DURATION,
        "5m",
        env="KAVACH_ONTOLOGY_RECONCILIATION_INTERVAL",
        runtime_applied=True,
    ),
    _definition(
    ...
    _definition(
        ...
        T.DURATION,
        "15m",
        env="KAVACH_AUDIT_INTERRUPTED_TIMEOUT",
        runtime_applied=True,
    ),
    _definition(
        "audit.backend",
    ...
    _definition(
        ...
        T.BOOLEAN,
        False,
        env="KAVACH_MCP_DRY_RUN_DEFAULT",
        runtime_applied=True,
    ),
    _definition(
        "mcp.audit_required",
    ...
    _definition(
        ...
        T.DURATION,
        "24h",
        env="KAVACH_MCP_IDEMPOTENCY_EXPIRY",
        runtime_applied=True,
    ),
    _definition(
        "integrations.openai",
    ...
    _definition(
        ...
        "disconnected",
        mutable=False,
        env="KAVACH_MSTEAMS_WEBHOOK_URL",
        enum=("connected", "disconnected"),
        sensitive=True,
    ),
    _definition(
