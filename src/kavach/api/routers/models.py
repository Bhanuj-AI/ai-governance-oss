...
from kavach.api.dependencies import get_model_registry_service
from kavach.api.dependencies.tenancy import get_compatible_tenant_context
from kavach.api.models import ErrorResponse, ModelObservationRequest, ModelResponse
...
@router.post(
    ...
    description=(
        ...
        "execution/evaluation producer. Kavach does not configure the runtime."
    ),
)
def observe_model(
