"""
Governance insights and report wiring for the Kavach platform.
"""
...
def get_experiment_insight_service(
    ...
    from kavach.services.governance_insights import ExperimentInsightService
...
def get_drift_explanation_service(
    ...
    from kavach.services.governance_insights import DriftExplanationService
...
def get_governance_report_service(
    ...
    from kavach.services.governance_insights import GovernanceReportService
...
def get_governance_api_service(
    ...
    from kavach.services.governance_api_service import GovernanceApiService
