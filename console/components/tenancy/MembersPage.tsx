...
export function MembersPage() {
  ...
  return <div className="studio-page space-y-6"><div><h1 className="text-3xl font-semibold">Members</h1><p className="mt-1 text-sm text-muted-foreground">Display names are descriptive. Actor IDs are the stable identities used for access and audit.</p></div><OrganizationNav />
